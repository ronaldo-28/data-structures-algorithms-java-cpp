<h2><a href="https://leetcode.com/problems/valid-k-unique-subarrays-ii">4001. Valid K-Unique Subarrays II</a></h2><h3>Hard</h3><hr><p>You are given an integer array <code>nums</code> of length <code>n</code> and an integer <code>k</code>.</p>
