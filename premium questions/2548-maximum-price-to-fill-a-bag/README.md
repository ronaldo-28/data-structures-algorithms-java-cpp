<h2><a href="https://leetcode.com/problems/maximum-price-to-fill-a-bag">2693. Maximum Price to Fill a Bag</a></h2><h3>Medium</h3><hr><p>You are given a 2D integer array <code>items</code> where <code>items[i] = [price<sub>i</sub>, weight<sub>i</sub>]</code> denotes the price and weight of the <code>i<sup>th</sup></code> item, respectively.</p>
