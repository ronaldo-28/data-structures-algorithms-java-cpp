<h2><a href="https://leetcode.com/problems/apply-discount-every-n-orders/description/?__cf_chl_rt_tk=2Q0ctveDuUX1C62BM3yLglamnoowDBRqC.KkqxH27sM-1771681007-1.0.1.1-bzPokqLyEcWTahZLIHM8ok5RLJoxwzOnf9mT20bbBTI">1459. Apply Discount Every n Orders</a></h2><h3>Medium</h3><hr><p>There is a supermarket that is frequented by many customers. The products sold at the supermarket are represented as two parallel integer arrays <code>products</code> and <code>prices</code>, where the <code>i<sup>th</sup></code> product has an ID of <code>products[i]</code> and a price of <code>prices[i]</code>.</p>
