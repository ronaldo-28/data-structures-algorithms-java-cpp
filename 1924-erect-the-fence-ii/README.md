<h2><a href="https://leetcode.com/problems/erect-the-fence-ii">2074. Erect the Fence II</a></h2><h3>Hard</h3><hr><p>You are given a 2D integer array <code>trees</code> where <code>trees[i] = [x<sub>i</sub>, y<sub>i</sub>]</code> represents the location of the <code>i<sup>th</sup></code> tree in the garden.</p>
